...
namespace GabbyDialogueSample
{
    public class SampleScriptingHandler : AbstractScriptingHandler
    {
        ...
        public SampleScriptingHandler()
        {
            ...
            // Nim sample actions
            // ==================
            GameObject gameUI = GameObject.Instantiate(Resources.Load("UI/NimUI", typeof(GameObject))) as GameObject;
            ...
            // Vendor scripts
            // ==============
            GameObject itemUI = GameObject.Instantiate(Resources.Load("UI/ItemPopupUI", typeof(GameObject))) as GameObject;
            GameObject goldUI = GameObject.Instantiate(Resources.Load("UI/GoldUI", typeof(GameObject))) as GameObject;
            ...
            // Lamp quest actions
            // ==================
            GameObject questUI = GameObject.Instantiate(Resources.Load("UI/QuestUI", typeof(GameObject))) as GameObject;
